...
| Folder | Contents |
|---|---|
| `/write-ups` | TryHackMe and Blue Team Labs Online challenge walkthroughs and analysis |
| `/home-lab` | Documentation and screenshots from my self-built SIEM home lab |
| `/incident-reports` | Simulated incident investigations written in professional report format |
| `/threat-intelligence` | MITRE ATT&CK threat analysis and adversary research |
| `/notes` | Concept notes and tool references built during active study |
...
*This section is updated as progress is made.*
...
[LinkedIn](https://www.linkedin.com/in/tambe-bryan-eyong-nkongho-b85863405/) <!-- Replace with your actual LinkedIn URL -->
